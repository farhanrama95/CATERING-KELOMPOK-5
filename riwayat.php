    ...
    <div class="container">
        ...
        <div class="riwayat-container">
            <table class="table-riwayat">
                ...
                <tbody>
                    <?php
                    $query = mysqli_query($koneksi, "SELECT * FROM orders WHERE user_id = '$user_id' ORDER BY tanggal_pesan DESC");
                    ...
                    <tr>
                        ...
                        <td><span class="badge <?= $status_class; ?>"><?= strtoupper($row['status_pesanan']); ?></span></td>
                    </tr>
                    <?php
                        }
                    } else {
