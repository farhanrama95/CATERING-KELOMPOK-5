...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .btn-logout-nav { background: #f0e8d0; color: #2d4a3e !important; padding: 6px 14px !important; }
        ...
        @media (max-width: 767px) {
            ...
            .nav-menu li a { padding: 14px 20px; border-radius: 0; border-bottom: 1px solid rgba(255,255,255,0.06); font-size: 15px; }
            .btn-logout-nav { background: transparent !important; color: #ff8a7a !important; border-bottom: none !important; }
        }
        ...
        .form-container { background: #fff; padding: 24px; border-radius: 10px; margin-bottom: 24px; border: 1px solid #d6e8d6; }
        .form-group { margin-bottom: 14px; }
        .form-group label { display: block; font-size: 13px; font-weight: bold; color: #3b5a48; margin-bottom: 5px; }
        ...
        .form-group input:focus, .form-group select:focus { border-color: #2d4a3e; }
        ...
        .btn-simpan { background: #2d4a3e; color: #f0e8d0; border: none; padding: 10px 22px; border-radius: 8px; font-size: 14px; font-weight: bold; cursor: pointer; transition: background 0.2s; }
        ...
        .table-admin th, .table-admin td { padding: 12px 15px; border: 1px solid #d6e8d6; text-align: left; font-size: 14px; }
        .table-admin th { background-color: #2d4a3e; color: #f0e8d0; font-weight: bold; }
        .table-admin tr:nth-child(even) { background-color: #f5f0e8; }
        .table-admin tr:hover { background-color: #e8f0e8; }
        .btn-danger { background: #fff; color: #c0392b; border: 1.5px solid #c0392b; padding: 5px 12px; border-radius: 6px; font-size: 12px; font-weight: bold; cursor: pointer; transition: all 0.2s; }
    ...
    <div class="form-container">
        <form action="proses_tambah_menu.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" name="nama_menu" required placeholder="Contoh: Nasi Kuning...">
            </div>
            <div class="form-group">
    ...
    <div class="table-wrapper">
        <table class="table-admin">
            ...
            <tbody>
                <?php
                // ✅ ORDER BY id_menus
                $query = mysqli_query($koneksi, "SELECT * FROM menus ORDER BY id_menus DESC");
                ...
                <tr>
                    ...
                    <td><?= htmlspecialchars($row['nama_menu']); ?></td>      <!-- ✅ nama_menu -->
                    ...
                    <td>
                        <form action="hapus_menu.php" method="POST" onsubmit="return confirm('Yakin ingin menghapus menu ini?');">
                            <input type="hidden" name="csrf_token" value="<?= htmlspecialchars($_SESSION['csrf_token']); ?>">
                            <input type="hidden" name="id_menus" value="<?= (int)$row['id_menus']; ?>"> <!-- ✅ id_menus -->
